          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuCheckboxItem
                ...
                onCheckedChange={(v) => setColumns((p) => ({ ...p, tarefa: v }))}
              >
                Tarefa
              </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem
                checked={columns.responsavel}
                onCheckedChange={(v) => setColumns((p) => ({ ...p, responsavel: v }))}
              >
                Responsável
              </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem
                checked={columns.dataEntrega}
                onCheckedChange={(v) => setColumns((p) => ({ ...p, dataEntrega: v }))}
              >
                Data de Entrega
              </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem
                checked={columns.status}
                onCheckedChange={(v) => setColumns((p) => ({ ...p, status: v }))}
              >
                Status
              </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem
                checked={columns.acoes}
                onCheckedChange={(v) => setColumns((p) => ({ ...p, acoes: v }))}
              >
                Ações
              </DropdownMenuCheckboxItem>
            </DropdownMenuContent>
