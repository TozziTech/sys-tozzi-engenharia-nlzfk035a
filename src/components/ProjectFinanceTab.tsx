      ...
      <div className="space-y-6 transition-opacity duration-200">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-semibold tracking-tight">Dashboard Financeiro</h2>
          </div>
          <Select value={periodFilter} onValueChange={setPeriodFilter}>
            <SelectTrigger className="w-[200px] bg-white dark:bg-slate-950 shadow-sm">
        ...
        {loading && records.length === 0 ? (
          <div className="space-y-6 animate-pulse">
            <div className="h-32 bg-muted/60 rounded-xl border" />
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="h-64 bg-muted/60 rounded-xl border" />
              <div className="h-64 bg-muted/60 rounded-xl border" />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="h-28 bg-muted/60 rounded-xl border" />
              <div className="h-28 bg-muted/60 rounded-xl border" />
              <div className="h-28 bg-muted/60 rounded-xl border" />
            </div>
            <div className="h-96 bg-muted/60 rounded-xl border" />
          </div>
        ) : (
          <>
